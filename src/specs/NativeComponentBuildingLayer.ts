...
interface NativeComponentsBuildingLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsBuildingLayerProps>(
  'RnMapboxToolkitBuildingLayer'
) as HostComponent<NativeComponentsBuildingLayerProps>;
