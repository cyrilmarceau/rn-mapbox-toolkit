...
interface NativeComponentsFillExtrusionLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsFillExtrusionLayerProps>(
  'RnMapboxToolkitFillExtrusionLayer'
) as HostComponent<NativeComponentsFillExtrusionLayerProps>;
