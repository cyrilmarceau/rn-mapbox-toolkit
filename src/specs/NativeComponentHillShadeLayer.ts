...
interface NativeComponentsHillshadeLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsHillshadeLayerProps>(
  'RnMapboxToolkitHillshadeLayer'
) as HostComponent<NativeComponentsHillshadeLayerProps>;
