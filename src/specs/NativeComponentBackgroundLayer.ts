...
interface NativeComponentsBackgroundLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsBackgroundLayerProps>(
  'RnMapboxToolkitBackgroundLayer'
) as HostComponent<NativeComponentsBackgroundLayerProps>;
