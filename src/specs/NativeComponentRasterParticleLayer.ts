...
interface NativeComponentsRasterParticleLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsRasterParticleLayerProps>(
  'RnMapboxToolkitRasterParticleLayer'
) as HostComponent<NativeComponentsRasterParticleLayerProps>;
