...
interface NativeComponentsSkyLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsSkyLayerProps>(
  'RnMapboxToolkitSkyLayer'
) as HostComponent<NativeComponentsSkyLayerProps>;
