...
interface NativeComponentsHeatmapLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsHeatmapLayerProps>(
  'RnMapboxToolkitHeatmapLayer'
) as HostComponent<NativeComponentsHeatmapLayerProps>;
