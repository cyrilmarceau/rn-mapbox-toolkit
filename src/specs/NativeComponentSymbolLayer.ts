...
interface NativeComponentsSymbolLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsSymbolLayerProps>(
  'RnMapboxToolkitSymbolLayer'
) as HostComponent<NativeComponentsSymbolLayerProps>;
