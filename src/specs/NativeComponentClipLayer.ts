...
interface NativeComponentsClipLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsClipLayerProps>(
  'RnMapboxToolkitClipLayer'
) as HostComponent<NativeComponentsClipLayerProps>;
