...
interface NativeComponentsRasterLayerProps extends ViewProps {
  layerID: string;
  minZoom?: Double;
  maxZoom?: Double;
...
export default codegenNativeComponent<NativeComponentsRasterLayerProps>(
  'RnMapboxToolkitRasterLayer'
) as HostComponent<NativeComponentsRasterLayerProps>;
